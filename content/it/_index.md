...
[services]
  title = "Calendario"
  text = "Visualizza l'orario delle solennità annuali per parrocchie nel [Calendario](/it/kalendar/)."
[feature_icons]
  enable = true
  [[feature_icons.tile]]
    icon = "fa-rss"
    ...
    accent = "1"
    title = "Notizie"
    text = "Le ultime dalla parrocchia"
    url = "/it/posts"
  [[feature_icons.tile]]
    icon = "fa-church"
    icon_pack = "fas"
  ...
  [[feature_icons.tile]]
    ...
    accent = "5"
    title = "Catechesi"
    text = "Il futuro appartiene ai giovani"
    url = "/it/vjeronauk"
  [[feature_icons.tile]]
    icon = "fa-cross"
    icon_pack = "fas"
...
[feature_images]
  enable = true
  [[feature_images.tile]]
    title = "Comune di Šolta"
    url = "https://visitsolta.com/"
    button_text = "Visita Šolta"
  [[feature_images.tile]]
...
[CTA]
  ...
  message = "Saremo felici di sentirti."
+++
